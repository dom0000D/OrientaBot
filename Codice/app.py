...
logo = PhotoImage(file="../Img/logo.png")  # load logo
...
class ChatApplication:
    ...
    def setup_main_window(self):
        ...
        # text widget
        self.text_widget = Text(self.window, width=40, height=2, bg="#f7ecda", font="Helvetica 18", padx=10, pady=10, wrap="word")
        self.text_widget.place(relheight=0.745, relwidth=1, rely=0.08)
        self.text_widget.configure(cursor="trek", state=DISABLED)

        # foto del bot a destra
        self.photo = PhotoImage(file="../Img/c.png")
        ...
        # send button
        button_image = PhotoImage(file="../Img/v.png")
